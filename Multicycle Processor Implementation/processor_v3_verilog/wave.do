...
add wave -position end  sim:/multicycle_tb/DUT/X1/data
add wave -position end  sim:/multicycle_tb/DUT/Control/state
add wave -position end  sim:/multicycle_tb/DUT/Control/stop
add wave -position 23  sim:/multicycle_tb/DUT/Control/instr
add wave -position insertpoint  \
sim:/multicycle_tb/DUT/VRF_block/v0 \
sim:/multicycle_tb/DUT/VRF_block/v1 \
sim:/multicycle_tb/DUT/VRF_block/v2 \
sim:/multicycle_tb/DUT/VRF_block/v3 \
sim:/multicycle_tb/DUT/VRF_block/k0 \
sim:/multicycle_tb/DUT/VRF_block/k1
add wave -position insertpoint sim:/multicycle_tb/DUT/R2/*
update
